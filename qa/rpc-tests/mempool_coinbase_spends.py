...
class MempoolCoinbaseTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        spend_102_id = self.nodes[0].sub1xrawtransaction(spend_102_raw)
        spend_103_id = self.nodes[0].sub1xrawtransaction(spend_103_raw)
        ...
        spend_103_1_id = self.nodes[0].sub1xrawtransaction(spend_103_1_raw)
        self.nodes[0].setgenerate(True, 1)

        # ... now put spend_101 and spend_102_1 in memory pools:
        spend_101_id = self.nodes[0].sub1xrawtransaction(spend_101_raw)
        spend_102_1_id = self.nodes[0].sub1xrawtransaction(spend_102_1_raw)
