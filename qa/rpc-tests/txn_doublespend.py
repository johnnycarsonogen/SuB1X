...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to sub1x 1210 BTC to node1_address,
        # but don't broadcast:
        ...
        txid1 = self.nodes[0].sub1xfrom("foo", node1_address, 1210, 0)
        txid2 = self.nodes[0].sub1xfrom("bar", node1_address, 20, 0)
        ...
        mutated_txid = self.nodes[2].sub1xrawtransaction(doublespend["hex"])
        # ... mine a block...
        ...
        # Node1's "from" account balance should be just the mutated sub1x:
