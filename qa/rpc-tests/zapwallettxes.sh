...
# Sub1x 1 XBT from testaccount
TXID1_TESTACCOUNT=$($CLI $B1ARGS sub1xfrom "testaccount" "mrhz5ZgSF3C1BSdyCKt3gEdhKoRL5BNfJV" 1)
TXID2_TESTACCOUNT=$($CLI $B2ARGS sub1xfrom "testaccount" "mrhz5ZgSF3C1BSdyCKt3gEdhKoRL5BNfJV" 1)
