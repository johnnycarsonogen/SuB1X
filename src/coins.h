...
/** 
    ...
    ****Note - for SUB1X we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of sub1x coming in to a transaction
