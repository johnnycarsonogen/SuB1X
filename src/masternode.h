...
//
// The Masternode Ping Class : Contains a different serialize method for sub1xing pings from masternodes throughout the network
//
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 SUB1X, signature to prove
...
//
// The Masternode Broadcast Class : Contains a different serialize method for sub1xing masternodes through the network
//
