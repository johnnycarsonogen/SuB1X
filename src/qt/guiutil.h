...
/** Utility functions used by the SUB1X Qt UI.
 */
namespace GUIUtil
{
...
// Render SUB1X addresses in monospace font
...
// Parse "sub1x:" URI into recipient object, return true on successful parsing
