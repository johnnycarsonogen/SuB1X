...
// but the main window (and the Sub1x Coins tab) is not.
//
// So, the strategy is:
//
...
public:
    ...
    static bool ipcSub1xCommandLine();
...
signals:
    ...
    void receivedPaymentRequest(Sub1xCoinsRecipient);
...
public slots:
    ...
    void fetchPaymentACK(CWallet* wallet, Sub1xCoinsRecipient recipient, QByteArray transaction);
...
private:
    bool processPaymentRequest(PaymentRequestPlus& request, Sub1xCoinsRecipient& recipient);
