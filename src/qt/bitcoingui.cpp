                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SUB1X Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sub1xCoinsAction = new QAction(QIcon(":/icons/sub1x"), tr("&Sub1x"), this);
    sub1xCoinsAction->setStatusTip(tr("Sub1x coins to a SUB1X address"));
    sub1xCoinsAction->setToolTip(sub1xCoinsAction->statusTip());
    sub1xCoinsAction->setCheckable(true);
#ifdef Q_OS_MAC
    sub1xCoinsAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_2));
#else
    sub1xCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
#endif
    tabGroup->addAction(sub1xCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sub1x: URIs)"));
    ...
    // These showNormalIfMinimized are needed because Sub1x Coins and Receive Coins
    // can be triggered from the tray menu, and need to show the GUI to be useful.
    connect(overviewAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(overviewAction, SIGNAL(triggered()), this, SLOT(gotoOverviewPage()));
    connect(sub1xCoinsAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(sub1xCoinsAction, SIGNAL(triggered()), this, SLOT(gotoSub1xCoinsPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SUB1X Core"), this);
    aboutAction->setStatusTip(tr("Show information about SUB1X Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SUB1X"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SUB1X addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SUB1X addresses"));
    ...
    multiSub1xAction = new QAction(QIcon(":/icons/edit"), tr("&MultiSub1x"), this);
    multiSub1xAction->setToolTip(tr("MultiSub1x Settings"));
    multiSub1xAction->setCheckable(true);
    ...
    usedSub1xingAddressesAction = new QAction(QIcon(":/icons/address-book"), tr("&Sub1xing addresses..."), this);
    usedSub1xingAddressesAction->setStatusTip(tr("Show the list of used sub1xing addresses and labels"));
    usedReceivingAddressesAction = new QAction(QIcon(":/icons/address-book"), tr("&Receiving addresses..."), this);
    usedReceivingAddressesAction->setStatusTip(tr("Show the list of used receiving addresses and labels"));

    openAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_FileIcon), tr("Open &URI..."), this);
    openAction->setStatusTip(tr("Open a SUB1X: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SUB1X Core help message to get a list with possible SUB1X command-line options"));
    ...
    if (walletFrame) {
        ...
        connect(usedSub1xingAddressesAction, SIGNAL(triggered()), walletFrame, SLOT(usedSub1xingAddresses()));
        connect(usedReceivingAddressesAction, SIGNAL(triggered()), walletFrame, SLOT(usedReceivingAddresses()));
        connect(openAction, SIGNAL(triggered()), this, SLOT(openClicked()));
        connect(multiSub1xAction, SIGNAL(triggered()), this, SLOT(gotoMultiSub1xDialog()));
    }
#endif // ENABLE_WALLET
}
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        file->addSeparator();
        file->addAction(usedSub1xingAddressesAction);
    ...
    if (walletFrame) {
        ...
        settings->addAction(multiSub1xAction);
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        toolbar->addAction(sub1xCoinsAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    sub1xCoinsAction->setEnabled(enabled);
    ...
    usedSub1xingAddressesAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SUB1X Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::createTrayIconMenu()
{
    ...
    trayIconMenu->addAction(sub1xCoinsAction);
...
void BitcoinGUI::gotoSub1xCoinsPage(QString addr)
{
    sub1xCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSub1xCoinsPage(addr);
}
...
void BitcoinGUI::gotoMultiSub1xDialog()
{
    multiSub1xAction->setChecked(true);
    if (walletFrame)
        walletFrame->gotoMultiSub1xDialog();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SUB1X network", "", count));
}
...
{
    QString strTitle = tr("SUB1X Core"); // default title
...
void BitcoinGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address)
{
    ...
    message((amount) < 0 ? (pwalletMain->fMultiSub1xNotify == true ? tr("Sent MultiSub1x transaction") : tr("Sent transaction")) : tr("Incoming transaction"),
        tr("Date: %1\n"
           "Amount: %2\n"
           "Type: %3\n"
           "Address: %4\n")
    ...
    pwalletMain->fMultiSub1xNotify = false;
}
#endif // ENABLE_WALLET
...
#ifdef ENABLE_WALLET
bool BitcoinGUI::handlePaymentRequest(const Sub1xCoinsRecipient& recipient)
{
    // URI has to be valid
