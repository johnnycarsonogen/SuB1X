...
QT_MOC_LITERAL(5, 63, 27), // "anonymizeSub1xAmountChanged"
QT_MOC_LITERAL(6, 91, 26) // "coinControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "obfuscationRoundsChanged\0"
    "anonymizeSub1xAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->anonymizeSub1xAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeSub1xAmountChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void OptionsModel::anonymizeSub1xAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
