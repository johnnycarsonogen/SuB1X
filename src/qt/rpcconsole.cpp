...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    // Sub1x command-line arguments to BitcoinGUI::handleRestart()
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SUB1X RPC console.") + "<br>" +
...
void RPCConsole::updateNodeDetail(const CNodeCombinedStats* stats)
{
    ...
    ui->peerLastSub1x->setText(stats->nodeStats.nLastSub1x ? GUIUtil::formatDurationStr(GetTime() - stats->nodeStats.nLastSub1x) : tr("never"));
    ui->peerLastRecv->setText(stats->nodeStats.nLastRecv ? GUIUtil::formatDurationStr(GetTime() - stats->nodeStats.nLastRecv) : tr("never"));
    ui->peerBytesSent->setText(FormatBytes(stats->nodeStats.nSub1xBytes));
