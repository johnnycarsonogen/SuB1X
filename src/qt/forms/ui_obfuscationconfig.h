...
public:
    ...
    void retranslateUi(QDialog *ObfuscationConfig)
    {
        ...
        label_2->setText(QApplication::translate("ObfuscationConfig", "Use 2 separate masternodes to mix funds up to 10000 SUB1X", 0));
        label_3->setText(QApplication::translate("ObfuscationConfig", "Use 8 separate masternodes to mix funds up to 10000 SUB1X", 0));
        label_4->setText(QApplication::translate("ObfuscationConfig", "Use 16 separate masternodes", 0));
        label_6->setText(QApplication::translate("ObfuscationConfig", "This option is the quickest and will cost about ~0.025 SUB1X to anonymize 10000 SUB1X", 0));
        label_7->setText(QApplication::translate("ObfuscationConfig", "This option is moderately fast and will cost about 0.05 SUB1X to anonymize 10000 SUB1X", 0));
        ...
        label_9->setText(QApplication::translate("ObfuscationConfig", "0.1 SUB1X per 10000 SUB1X you anonymize.", 0));
    } // retranslateUi
