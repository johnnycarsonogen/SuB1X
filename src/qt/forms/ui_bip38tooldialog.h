...
public:
    ...
    void retranslateUi(QDialog *Bip38ToolDialog)
    {
        ...
        infoLabel_ENC->setText(QApplication::translate("Bip38ToolDialog", "Enter a Sub1x Address that you would like to encrypt using BIP 38. Enter a passphrase in the middle box. Press encrypt to compute the encrypted private key.", 0));
        label_5->setText(QApplication::translate("Bip38ToolDialog", "Address:", 0));
#ifndef QT_NO_TOOLTIP
        addressIn_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "The SUB1X address to sign the message with", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptKeyButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Sign the message to prove you own this SUB1X address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptedKeyIn_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "The SUB1X address the message was signed with", 0));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("Bip38ToolDialog", "Passphrase: ", 0));
#ifndef QT_NO_TOOLTIP
        decryptKeyButton_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "Verify the message to ensure it was signed with the specified SUB1X address", 0));
#endif // QT_NO_TOOLTIP
