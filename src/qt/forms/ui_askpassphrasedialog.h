...
public:
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        anonymizationCheckBox->setToolTip(QApplication::translate("AskPassphraseDialog", "Serves to disable the trivial sub1xmoney when OS account compromised. Provides no real security.", 0));
#endif // QT_NO_TOOLTIP
