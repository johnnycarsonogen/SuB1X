...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        peerLastSub1x = new QLabel(detailWidget);
        peerLastSub1x->setObjectName(QStringLiteral("peerLastSub1x"));
        peerLastSub1x->setCursor(QCursor(Qt::IBeamCursor));
        peerLastSub1x->setTextFormat(Qt::PlainText);
        peerLastSub1x->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout_3->addWidget(peerLastSub1x, 9, 2, 1, 1);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the SUB1X debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        ...
        label_15->setText(QApplication::translate("RPCConsole", "Last Sub1x", 0));
        peerLastSub1x->setText(QApplication::translate("RPCConsole", "N/A", 0));
