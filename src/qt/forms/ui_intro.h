...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to SUB1X Core.", 0));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where SUB1X Core will store its data.", 0));
        sizeWarningLabel->setText(QApplication::translate("Intro", "SUB1X Core will download and store a copy of the SUB1X block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", 0));
