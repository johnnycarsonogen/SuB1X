...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeSub1x = new QSpinBox(tabMain);
        anonymizeSub1x->setObjectName(QStringLiteral("anonymizeSub1x"));
        anonymizeSub1x->setMinimum(100);
        anonymizeSub1x->setMaximum(100000);
        anonymizeSub1x->setSingleStep(100);
        anonymizeSub1x->setValue(1000);

        horizontalLayout->addWidget(anonymizeSub1x);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start SUB1X after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start SUB1X on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of SUB1X to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the SUB1X client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the SUB1X network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting SUB1X.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/sub1x-project/sub1x-project-translations", 0));
...
#ifndef QT_NO_TOOLTIP
        unit->setToolTip(QApplication::translate("OptionsDialog", "Choose the default subdivision unit to show in the interface and when sub1xing coins.", 0));
#endif // QT_NO_TOOLTIP
