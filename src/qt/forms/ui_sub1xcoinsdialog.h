/********************************************************************************
** Form generated from reading UI file 'sub1xcoinsdialog.ui'
**
...
#ifndef UI_SUB1XCOINSDIALOG_H
#define UI_SUB1XCOINSDIALOG_H
...
public:
    ...
    void setupUi(QDialog *Sub1xCoinsDialog)
    {
        if (Sub1xCoinsDialog->objectName().isEmpty())
            Sub1xCoinsDialog->setObjectName(QStringLiteral("Sub1xCoinsDialog"));
        Sub1xCoinsDialog->resize(850, 610);
        verticalLayout = new QVBoxLayout(Sub1xCoinsDialog);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(-1, -1, -1, 8);
        frameCoinControl = new QFrame(Sub1xCoinsDialog);
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 SUB1X"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 SUB1X"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 SUB1X"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 SUB1X"));
        ...
        scrollArea = new QScrollArea(Sub1xCoinsDialog);
        ...
        frameFee = new QFrame(Sub1xCoinsDialog);
        ...
        groupCustomFee = new QButtonGroup(Sub1xCoinsDialog);
        ...
        groupFee = new QButtonGroup(Sub1xCoinsDialog);
        ...
        sub1xButton = new QPushButton(Sub1xCoinsDialog);
        sub1xButton->setObjectName(QStringLiteral("sub1xButton"));
        sub1xButton->setMinimumSize(QSize(150, 0));
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/sub1x"), QSize(), QIcon::Normal, QIcon::Off);
        sub1xButton->setIcon(icon);
        sub1xButton->setAutoDefault(false);

        horizontalLayout->addWidget(sub1xButton);

        clearButton = new QPushButton(Sub1xCoinsDialog);
        ...
        addButton = new QPushButton(Sub1xCoinsDialog);
        ...
        checkUseObfuscation = new QCheckBox(Sub1xCoinsDialog);
        ...
        checkSwiftTX = new QCheckBox(Sub1xCoinsDialog);
        ...
        label = new QLabel(Sub1xCoinsDialog);
        label->setObjectName(QStringLiteral("label"));

        horizontalLayout_2->addWidget(label);

        labelBalance = new QLabel(Sub1xCoinsDialog);
        ...
        labelBalance->setText(QStringLiteral("123.456 SUB1X"));
        ...
        retranslateUi(Sub1xCoinsDialog);

        sub1xButton->setDefault(true);


        QMetaObject::connectSlotsByName(Sub1xCoinsDialog);
    } // setupUi

    void retranslateUi(QDialog *Sub1xCoinsDialog)
    {
        Sub1xCoinsDialog->setWindowTitle(QApplication::translate("Sub1xCoinsDialog", "Sub1x Coins", 0));
        labelCoinControlFeatures->setText(QApplication::translate("Sub1xCoinsDialog", "Coin Control Features", 0));
        pushButtonCoinControl->setText(QApplication::translate("Sub1xCoinsDialog", "Inputs...", 0));
        labelCoinControlAutomaticallySelected->setText(QApplication::translate("Sub1xCoinsDialog", "automatically selected", 0));
        labelCoinControlInsuffFunds->setText(QApplication::translate("Sub1xCoinsDialog", "Insufficient funds!", 0));
        labelCoinControlQuantityText->setText(QApplication::translate("Sub1xCoinsDialog", "Quantity:", 0));
        labelCoinControlBytesText->setText(QApplication::translate("Sub1xCoinsDialog", "Bytes:", 0));
        labelCoinControlAmountText->setText(QApplication::translate("Sub1xCoinsDialog", "Amount:", 0));
        labelCoinControlPriorityText->setText(QApplication::translate("Sub1xCoinsDialog", "Priority:", 0));
        labelCoinControlPriority->setText(QApplication::translate("Sub1xCoinsDialog", "medium", 0));
        labelCoinControlFeeText->setText(QApplication::translate("Sub1xCoinsDialog", "Fee:", 0));
        labelCoinControlLowOutputText->setText(QApplication::translate("Sub1xCoinsDialog", "Dust:", 0));
        labelCoinControlLowOutput->setText(QApplication::translate("Sub1xCoinsDialog", "no", 0));
        labelCoinControlAfterFeeText->setText(QApplication::translate("Sub1xCoinsDialog", "After Fee:", 0));
        labelCoinControlChangeText->setText(QApplication::translate("Sub1xCoinsDialog", "Change:", 0));
#ifndef QT_NO_TOOLTIP
        checkBoxCoinControlChange->setToolTip(QApplication::translate("Sub1xCoinsDialog", "If this is activated, but the change address is empty or invalid, change will be sent to a newly generated address.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxCoinControlChange->setText(QApplication::translate("Sub1xCoinsDialog", "Custom change address", 0));
        splitBlockCheckBox->setText(QApplication::translate("Sub1xCoinsDialog", "Split UTXO", 0));
        splitBlockLineEdit->setPlaceholderText(QApplication::translate("Sub1xCoinsDialog", "# of outputs", 0));
        labelBlockSizeText->setText(QApplication::translate("Sub1xCoinsDialog", "UTXO Size:", 0));
        labelBlockSize->setText(QApplication::translate("Sub1xCoinsDialog", "0 SUB1X", 0));
        labelCoinControlChangeLabel->setText(QString());
        labelFeeHeadline->setText(QApplication::translate("Sub1xCoinsDialog", "Transaction Fee:", 0));
        labelFeeMinimized->setText(QString());
        buttonChooseFee->setText(QApplication::translate("Sub1xCoinsDialog", "Choose...", 0));
#ifndef QT_NO_TOOLTIP
        buttonMinimizeFee->setToolTip(QApplication::translate("Sub1xCoinsDialog", "collapse fee-settings", 0));
#endif // QT_NO_TOOLTIP
        buttonMinimizeFee->setText(QApplication::translate("Sub1xCoinsDialog", "Minimize", 0));
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("Sub1xCoinsDialog", "If the custom fee is set to 1000 uSUB1Xs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uSUB1Xs in fee,<br />while \"at least\" pays 1000 uSUB1Xs. For transactions bigger than a kilobyte both pay by kilobyte.", 0));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("Sub1xCoinsDialog", "per kilobyte", 0));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("Sub1xCoinsDialog", "If the custom fee is set to 1000 uSUB1Xs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uSUB1Xs in fee,<br />while \"total at least\" pays 1000 uSUB1Xs. For transactions bigger than a kilobyte both pay by kilobyte.", 0));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("Sub1xCoinsDialog", "total at least", 0));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("Sub1xCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for SUB1X transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("Sub1xCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for SUB1X transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
        labelMinFeeWarning->setText(QApplication::translate("Sub1xCoinsDialog", "(read the tooltip)", 0));
        radioCustomFee->setText(QString());
        labelSmartFee3->setText(QApplication::translate("Sub1xCoinsDialog", "Confirmation time:", 0));
        labelSmartFeeNormal->setText(QApplication::translate("Sub1xCoinsDialog", "normal", 0));
        labelSmartFeeFast->setText(QApplication::translate("Sub1xCoinsDialog", "fast", 0));
        labelSmartFee_2->setText(QApplication::translate("Sub1xCoinsDialog", "Recommended", 0));
        radioSmartFee->setText(QString());
        labelCustomFee->setText(QApplication::translate("Sub1xCoinsDialog", "Custom:", 0));
        labelSmartFee->setText(QString());
        labelFeeEstimation->setText(QString());
        labelSmartFee2->setText(QApplication::translate("Sub1xCoinsDialog", "(Smart fee not initialized yet. This usually takes a few blocks...)", 0));
        checkBoxFreeTx->setText(QApplication::translate("Sub1xCoinsDialog", "Sub1x as zero-fee transaction if possible", 0));
        labelFreeTx->setText(QApplication::translate("Sub1xCoinsDialog", "(confirmation may take longer)", 0));
#ifndef QT_NO_TOOLTIP
        sub1xButton->setToolTip(QApplication::translate("Sub1xCoinsDialog", "Confirm the sub1x action", 0));
#endif // QT_NO_TOOLTIP
        sub1xButton->setText(QApplication::translate("Sub1xCoinsDialog", "S&end", 0));
#ifndef QT_NO_TOOLTIP
        clearButton->setToolTip(QApplication::translate("Sub1xCoinsDialog", "Clear all fields of the form.", 0));
#endif // QT_NO_TOOLTIP
        clearButton->setText(QApplication::translate("Sub1xCoinsDialog", "Clear &All", 0));
#ifndef QT_NO_TOOLTIP
        addButton->setToolTip(QApplication::translate("Sub1xCoinsDialog", "Sub1x to multiple recipients at once", 0));
#endif // QT_NO_TOOLTIP
        addButton->setText(QApplication::translate("Sub1xCoinsDialog", "Add &Recipient", 0));
        checkUseObfuscation->setText(QApplication::translate("Sub1xCoinsDialog", "Obfuscation", 0));
        checkSwiftTX->setText(QApplication::translate("Sub1xCoinsDialog", "SwiftTX", 0));
        label->setText(QApplication::translate("Sub1xCoinsDialog", "Balance:", 0));
    } // retranslateUi

};

namespace Ui {
    class Sub1xCoinsDialog: public Ui_Sub1xCoinsDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SUB1XCOINSDIALOG_H
