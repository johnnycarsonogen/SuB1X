...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::Sub1xToAddress:
    case TransactionRecord::Sub1xToOther:
        return tr("Sent to");
    case TransactionRecord::Sub1xToSelf:
...
QString TransactionTableModel::formatTooltip(const TransactionRecord* rec) const
{
    ...
    if (rec->type == TransactionRecord::RecvFromOther || rec->type == TransactionRecord::Sub1xToOther ||
        rec->type == TransactionRecord::Sub1xToAddress || rec->type == TransactionRecord::RecvWithAddress || rec->type == TransactionRecord::MNReward) {
