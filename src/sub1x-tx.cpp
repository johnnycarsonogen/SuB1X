...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sub1x Core sub1x-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sub1x-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sub1x transaction") + "\n" +
                               "  sub1x-tx [options] -create [commands]   " + _("Create hex-encoded sub1x transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sub1x transaction
