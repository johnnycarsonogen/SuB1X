...
/** Number of headers sent in one getheaders result. We rely on the assumption that if a peer sub1xs
...
/**
 * Sub1x queued protocol messages to be sent to a give node.
 *
 * @param[in]   pto             The node which we are sub1xing messages to.
 * @param[in]   fSub1xTrickle    When true sub1x the trickled data, otherwise trickle the data until true.
 */
...
protected:
    ...
    virtual void Resub1xWalletTransactions(){};
