...
BOOST_AUTO_TEST_CASE(rpc_rawparams)
{
    ...
    // Only check failure cases for sub1xrawtransaction, there's no network to sub1x to...
    BOOST_CHECK_THROW(CallRPC("sub1xrawtransaction"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("sub1xrawtransaction null"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("sub1xrawtransaction DEADBEEF"), runtime_error);
    BOOST_CHECK_THROW(CallRPC(string("sub1xrawtransaction ")+rawtx+" extra"), runtime_error);
}
