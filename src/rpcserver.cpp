...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"rawtransactions", "sub1xrawtransaction", &sub1xrawtransaction, false, false, false},
        ...
        /* sub1x features */
        {"sub1x", "masternode", &masternode, true, true, false},
        {"sub1x", "listmasternodes", &listmasternodes, true, true, false},
        {"sub1x", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sub1x", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sub1x", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sub1x", "masternodedebug", &masternodedebug, true, true, false},
        {"sub1x", "startmasternode", &startmasternode, true, true, false},
        {"sub1x", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sub1x", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sub1x", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sub1x", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sub1x", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sub1x", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sub1x", "mnbudget", &mnbudget, true, true, false},
        {"sub1x", "preparebudget", &preparebudget, true, true, false},
        {"sub1x", "submitbudget", &submitbudget, true, true, false},
        {"sub1x", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sub1x", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sub1x", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sub1x", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sub1x", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sub1x", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sub1x", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sub1x", "checkbudgets", &checkbudgets, true, true, false},
        {"sub1x", "mnsync", &mnsync, true, true, false},
        {"sub1x", "spork", &spork, true, true, false},
        {"sub1x", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"sub1x", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of Sub1xMoney */
...
{
    // Sub1x error reply from json-rpc error object
    ...
    const boost::system::error_code& error)
{
    ...
    // certain DoS and misbehaving clients.
        ...
        // Only sub1x a 403 if we're not using SSL to prevent a DoS during the SSL handshake.
        if (!fUseSSL)
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sub1xd, or the -server option to sub1x-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> sub1x-cli " + methodname + " " + args + "\n";
}
