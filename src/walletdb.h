...
public:
    ...
    bool WriteMultiSub1x(std::vector<std::pair<std::string, int> > vMultiSub1x);
    bool EraseMultiSub1x(std::vector<std::pair<std::string, int> > vMultiSub1x);
    bool WriteMSettings(bool fMultiSub1xStake, bool fMultiSub1xMasternode, int nLastMultiSub1xHeight);
