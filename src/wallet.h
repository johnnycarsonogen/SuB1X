...
extern bool fSub1xFreeTransactions;
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 SUB1X at the same time
...
private:
    ...
    int64_t nNextResub1x;
    int64_t nLastResub1x;
...
public:
    ...
    //MultiSub1x
    std::vector<std::pair<std::string, int> > vMultiSub1x;
    bool fMultiSub1xStake;
    bool fMultiSub1xMasternodeReward;
    bool fMultiSub1xNotify;
    std::string strMultiSub1xChangeAddress;
    int nLastMultiSub1xHeight;
    ...
    void SetNull()
    {
        ...
        //MultiSub1x
        vMultiSub1x.clear();
        fMultiSub1xStake = false;
        fMultiSub1xMasternodeReward = false;
        fMultiSub1xNotify = false;
        strMultiSub1xChangeAddress = "";
        nLastMultiSub1xHeight = 0;
    ...
    bool isMultiSub1xEnabled()
    {
        return fMultiSub1xMasternodeReward || fMultiSub1xStake;
    }

    void setMultiSub1xDisabled()
    {
        fMultiSub1xMasternodeReward = false;
        fMultiSub1xStake = false;
    }
    ...
    void Resub1xWalletTransactions();
    ...
    bool CreateTransaction(const std::vector<std::pair<CScript, CAmount> >& vecSub1x,
        CWalletTx& wtxNew,
