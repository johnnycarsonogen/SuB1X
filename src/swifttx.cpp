...
//         Sub1x "txvote", CTransaction, Signature, Approve
//step 3.) Top 1 masternode, waits for SWIFTTX_SIGNATURES_REQUIRED messages. Upon success, sub1xs "txlock'
...
int64_t CreateNewLock(CTransaction tx)
{
    ...
    BOOST_REVERSE_FOREACH (CTxIn i, tx.vin) {
        ...
        if (nTxAge < 5) //1 less than the "sub1x IX" gui requires, incase of a block propagating the network at the time
        {
