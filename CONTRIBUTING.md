Contributing to SUB1X Core
============================

The SUB1X Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SUB1X Core project, and is not to be
confused with overall SUB1X Network Protocol consensus changes.

Whether a pull request is merged into SUB1X Core rests with the project merge
...
Patches that change SUB1X consensus rules are considerably more involved than
...
Where a patch set proposes to change the SUB1X consensus, it must have been
...
The project leader is the release manager for each SUB1X Core release.
