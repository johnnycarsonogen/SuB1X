...
In order to support loading of multiple wallets in sub1x-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sub1x.cpp.
...
This widget owns five page views: overviewPage, transactionsPage, addressBookPage, receiveCoinsPage, and sub1xCoinsPage.
...
Changes to sub1x.cpp
----------------------
sub1x.cpp is the entry point into sub1x-qt, and as such, will require some minor modifications to provide hooks for
