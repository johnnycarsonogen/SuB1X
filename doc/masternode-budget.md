...
Sub1x now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<sub1x_address\> \<monthly_payment_sub1x\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ SUB1X, _12_ times over the course of a year totaling _24000_ SUB1X.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<sub1x_address\> \<monthly_payment_sub1x\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` SUB1X.
