...
This mechanism has been integrated into Bitcore-Node-SUB1X which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SUB1X-Project/insight-api-sub1x#web-socket-api](https://github.com/SUB1X-Project/insight-api-sub1x#web-socket-api) 
* API: [https://github.com/SUB1X-Project/insight-api-sub1x#swifttx-transactions](https://github.com/SUB1X-Project/insight-api-sub1x#swifttx-transactions) 
...
By default, the SUB1X Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SUB1X Core daemon:
